...
def main():
    ...
    # find minimal loss of expected future data
    curr_minimal_loss_vector = minimal_loss_vector(validation_countries_data, least_square_solution
                                                   , validation_france_data)
    print("the minimal loss (error) of expected future data is: ", vector_norm(curr_minimal_loss_vector))
    print("sanity check passed: ", sanity_check(validation_countries_data, curr_minimal_loss_vector))
    ...
    print("the ratio between our model error to the real france data is: ",
